---
title: "Investigating causal factors of fatal shark attacks"
...
abstract: |
  Using the Global Shark Attack File maintained by the Shark Research Institute, this project aims to investigate the causal factors leading to fatal shark attacks. Because the shark attack file only contains data on those who have been attacked, this study will focus on what makes a shark attack lethal. This will be accomplished by constucting a PGM with some of the variables found in the Global Shark Attack File such as location, species, time of day, season, activity, and others. The aim of this project is to identify which factors truly lead to fatal attacks by controlling for each of the factors listed before and considering their interactions to identify a solid model that accurately represents the causal relationships between them.
---
